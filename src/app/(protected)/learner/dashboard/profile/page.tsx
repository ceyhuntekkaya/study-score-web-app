...
export default function ProfilePage() {
  ...
  const profileData = [
    ...
    { label: 'First Name', value: user?.name?.split(' ')[0] || 'Emily' },
    { label: 'Last Name', value: user?.name?.split(' ')[1] || 'Hannah' },
    { label: 'Username', value: user?.email?.split('@')[0] || 'student' },
    { label: 'Email', value: user?.email || defaultEmail.display },
    { label: 'Phone Number', value: defaultPhone.display },
    { label: 'Skill/Occupation', value: 'Application Developer' },
