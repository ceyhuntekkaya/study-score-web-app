  ...
  const bannerSlides = [
    {
      ...
      subtitle: 'The Tesla of Exam Prep',
      title: 'Meet Your Personal AI Tutor: 24/7 Intelligence',
      description: 'Forget static textbooks. Experience an adaptive curriculum that evolves with you, finding your hidden weaknesses instantly with microscopic precision.',
      students: '50K+',
      studentsLabel: 'Target Scores Hit',
    },
    {
      id: 2,
      bgImage: '/assets/images/bg/bg-image-25.jpg',
      shape: '/assets/images/shape/m-banner-shape-01.png',
      subtitle: 'Micro-Precision Analysis',
      title: 'Don\'t Just Study Hard. Study Smart with Data.',
      description: 'Our AI identifies the exact points you are missing in IELTS, SAT, or TOEFL and creates a custom roadmap to fix them in record time.',
      students: '98%',
      studentsLabel: 'Satisfaction Rate',
    },
    {
      id: 3,
      bgImage: '/assets/images/bg/bg-image-26.jpg',
      shape: '/assets/images/shape/m-banner-shape-01.png',
      subtitle: 'Your Gateway to Ivy League',
      title: 'Global Success Starts With a Single Score',
      description: 'Join thousands of ambitious students securing their spots in top global universities. Your dream school is just one smart decision away.',
      students: '24/7',
      studentsLabel: 'AI Availability',
    },
  ];
