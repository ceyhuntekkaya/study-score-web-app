...
const addCriterion = () => {
  ...
  updateData({
    ...
    maxRecordingDuration: localData.maxRecordingDuration ?? 600,
    minRecordingDuration: localData.minRecordingDuration ?? 10,
    ...
    requiredQuality: localData.requiredQuality || "",
